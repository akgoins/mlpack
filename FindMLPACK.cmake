...
#find_library(MLPACK_LIBRARY 
#	NAMES mlpack
#	PATHS "${CMAKE_CURRENT_BINARY_DIR}/mlpack/lib"  "${CMAKE_CURRENT_BINARY_DIR}/mlpack/lib64" "${CMAKE_CURRENT_BINARY_DIR}/lib"
#	NO_DEFAULT_PATH
#)
set(MLPACK_LIBRARY "${CMAKE_CURRENT_BINARY_DIR}/lib")
...
set(MLPACK_INCLUDE_DIR "${CMAKE_CURRENT_BINARY_DIR}/include")
#find_path(MLPACK_INCLUDE_DIR 
#	NAMES mlpack/core.hpp mlpack/prereqs.hpp
...
if(MLPACK_INCLUDE_DIR)
  ...
  file(STRINGS "${CMAKE_CURRENT_SOURCE_DIR}/src/mlpack/core/util/version.hpp" _mlpack_HEADER_CONTENTS REGEX "#define MLPACK_VERSION_[A-Z]+ ")
...
if(MLPACK_FOUND)
	...
	set(MLPACK_ROOT_DIR ${CMAKE_CURRENT_SOURCE_DIR})
endif()
